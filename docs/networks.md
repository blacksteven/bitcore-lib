# Networks
Bitcore provides support for the main DEO network as well as for `testnet`, the current test blockchain. We encourage the use of `Networks.livenet` and `Networks.testnet` as constants. Note that the library sometimes may check for equality against this object. Please avoid creating a deep copy of this object.
...
Take a look at this modified snippet from [networks.js](https://github.com/blacksteven/bitcore-lib/blob/master/lib/networks.js)
